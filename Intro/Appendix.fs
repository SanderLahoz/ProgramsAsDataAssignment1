...
(* File Intro/Appendix.fs: The meta language F#, a crash course *)

module Appendix

(* Copy declarations from this file into the F# interactive top-level *)
